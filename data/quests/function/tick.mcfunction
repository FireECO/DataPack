...
execute as @a[scores={QuestProgressArene=0}] at @s if entity @p[distance=..3,x=0,y=-60,z=0] run function quests:arene_start
execute as @a[scores={QuestProgressArene=-1}] at @s if entity @p[distance=..3,x=0,y=-60,z=0] run function quests:arene_check
